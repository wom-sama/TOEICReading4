...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = TOEICReading4Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(TOEICReading4DbContext context)
    {
        _context = context;
    }
