...
public abstract class TOEICReading4WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static TOEICReading4WebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(TOEICReading4WebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<TOEICReading4DbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<TOEICReading4DbContext, Task> action)
    {
        using (var context = IocManager.Resolve<TOEICReading4DbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<TOEICReading4DbContext, Task<T>> func)
    {
        T result;
